...
path_to_results = ['D:\gf\GraphMOS-master\GraphMOS-master\instance_and_semantic_segmentation\CDNet2014_Dataset\sampling_patterns\',construction_algorithm,...
    '-',segmentation_algorithm,'-',background_inti_algorithm,'/'];
disp(path_to_results);
mkdir(path_to_results);
%%
load(['D:\gf\GraphMOS-master\GraphMOS-master\instance_and_semantic_segmentation\CDNet2014_Dataset\graph_construction\',construction_algorithm,'-',...
...
for i=1:size(folder_challenges,1)
    ...
    for j=1:size(folders_categories{i,1},1)
        ...
        %%
        list_of_images_cell_temp{j} = load(['D:/gf/GraphMOS-master/GraphMOS-master/instance_and_semantic_segmentation/CDNet2014_Dataset/nodes_representation/',...
...
save([path_to_results,'random_sampling2.mat'],'random_sampling_pattern','percentage_sampling',...
    'repetitions','indentifier_category_in_nodes');
disp([path_to_results,'random_sampling2.mat']);